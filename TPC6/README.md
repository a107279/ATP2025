# TPC6: Tabela Meteorológica

## Andreia Machado Cardoso a107279

## Resumo
O TPC6 consistiu na criação de uma aplicação em Python que permita ao utilizador usar todas as funcionalidades desenvolvidas na ficha TP6.
